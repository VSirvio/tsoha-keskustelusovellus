...
ALTER TABLE permissions ADD FOREIGN KEY (uid) REFERENCES users ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE permissions ADD FOREIGN KEY (subforum) REFERENCES subforums ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
